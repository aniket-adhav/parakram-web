...
function Drawer({
  ...
  return React.createElement(DrawerPrimitive.Root, { 'data-slot': "drawer", ...props} )
}

function DrawerTrigger({
  ...props
}) {
  return React.createElement(DrawerPrimitive.Trigger, { 'data-slot': "drawer-trigger", ...props} )
}

function DrawerPortal({
  ...props
}) {
  return React.createElement(DrawerPrimitive.Portal, { 'data-slot': "drawer-portal", ...props} )
}

function DrawerClose({
  ...props
}) {
  return React.createElement(DrawerPrimitive.Close, { 'data-slot': "drawer-close", ...props} )
}
...
function DrawerContent({
  ...
  return (
    React.createElement(DrawerPortal, { 'data-slot': "drawer-portal"}
