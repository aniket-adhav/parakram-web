      ...
      <main className="relative pt-32 pb-20">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          >
            ...
            <h1 className="font-display text-4xl md:text-5xl text-white mb-4">Refund & Cancellation Policy</h1>
          ...
          >
            <section>
              <h2 className="font-display text-xl text-white mb-3">1. Refund Eligibility</h2>
              <p className="text-white/70 leading-relaxed">
                Refunds will only be processed if the event is cancelled by the organizing committee due to unforeseen circumstances.
              </p>
            </section>

            <section>
              <h2 className="font-display text-xl text-white mb-3">2. No Refund After Deadline</h2>
              <p className="text-white/70 leading-relaxed">
                No refunds will be provided after the registration deadline has passed. Please ensure all details are correct before completing your registration.
              </p>
            </section>

            <section>
              <h2 className="font-display text-xl text-white mb-3">3. Event Cancellation</h2>
              <p className="text-white/70 leading-relaxed">
                In case of event cancellation by the organizers, registered participants will receive a full refund within 7-10 business days to their original payment method.
              </p>
            </section>

            <section>
              <h2 className="font-display text-xl text-white mb-3">4. Contact for Refunds</h2>
              <p className="text-white/70 leading-relaxed">
                For refund-related queries, contact us at <span className="text-orange-400">refunds@parakram2025.com</span>
              </p>
            </section>
          </motion.div>
      ...
      <footer className="border-t border-white/10 py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-6 mt-4 flex-wrap">
            ...
            <Link href="/refund-policy" className="text-orange-400 text-sm">Refund Policy</Link>
