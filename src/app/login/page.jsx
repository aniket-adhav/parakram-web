      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              Login to register for sports and get your jersey
            </motion.p>
          </div>
            ...
            >
              ...
              `}</style>
            {/* MOBILE BUTTON (icon + "Google") */}
        <button
          onClick={handleGoogleLogin}
          disabled={googleLoading}
          className="shiny-cta focus:outline-none relative w-full sm:hidden"
        >
        ...
        <button
          onClick={handleGoogleLogin}
          disabled={googleLoading}
          className="shiny-cta focus:outline-none relative w-full hidden sm:block"
        >
          <span className="relative z-10 flex items-center justify-center gap-3 min-h-[28px]">
            {googleLoading ? (
              <>
